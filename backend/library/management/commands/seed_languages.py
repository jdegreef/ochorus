        ...
        rows.append(
            {
                ...
                # Absent on every public-domain entry, which is most of them.
                "bible_licence": cfg.get("bible_licence", ""),
                "bible_attribution": cfg.get("bible_attribution", ""),
    ...
    def handle(self, *args, **opts):
        ...
        for row in _rows():
            ...
            identity = {
                ...
                "bible_licence": row["bible_licence"],
                "bible_attribution": row["bible_attribution"],
