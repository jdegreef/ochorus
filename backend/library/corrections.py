...
# `<div class="poem">`, the ornamental break as `<div><b>. . . . . . .</b></div>`
# and the imprint "LONDON: MORGAN AND SCOTT" likewise. The importer handed those
# divs to the sanitizer, which unwrapped them: the text shipped as loose runs,
# 79 in the English. `ingest.display_line` keeps them now (PR #3355);
...
# "From" lines and the imprint sit behind `<br>`s of their own, which
