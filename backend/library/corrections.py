...
BODY_CORRECTIONS: dict[str, dict] = {
    ...
    "unfailing-springs": {
        "restored_blocks": [
            ...
            # am
            ("<p>የክርስትና ትልቁ ማስረጃ",
             "<p>«የወደደም የሕይወትን ውኃ እንዲያው ይውሰድ»<br/> (ራእይ 22:17)</p>"),
        ],
    },
    "essentials-of-prayer": {
    ...
    "blessed-adversity": {
        ...
        "restored_blocks": [
            ...
            # am
            ("<p>በመጀመሪያው መዝሙር ላይ", "<h3>መግቢያ</h3>"),
            ("<p>በምዕራፍ 1 ቁጥር 8 ላይ", "<h3>የእግዚአብሔር ምስክርነትና ተግዳሮት</h3>"),
            ("<p>በምዕራፍ 1 ቁጥር 8 ላይ",
             "<p><em>«እግዚአብሔር ሰጠ፥ እግዚአብሔርም ነሣ፤ የእግዚአብሔር ስም የተባረከ ይሁን</em>»።—ኢዮብ 1:21።</p>"),
            ("<p>የሰይጣን መልስ ልብ ሊባል", "<h3>የማይታየው አጥር</h3>"),
            ("<p>ወደ ኢዮብ ታሪክ ስንመለስ", "<h3>የኢዮብ መፈተን</h3>"),
            ("<p>ብዙም ሳይቆይ ሰይጣን", "<h3>የሰይጣን ክፋት</h3>"),
            ("<p>ነገር ግን ፈተናውን የላከው", "<h3>በቂ ጸጋ</h3>"),
            ("<p>ነገር ግን ቀደም ብለን እንዳየነው", "<h3>ጥልቅ ፈተናዎች</h3>"),
            ("<p>እግዚአብሔር ለባሪያው የሰጠው", "<h3>የጌታ ቸርነት</h3>"),
        ],
    },
...
# Mott, *The Evangelization of the World in This Generation* (1900), built by
# `build_evangelization_of_the_world` from the Internet Archive OCR of the 1901
# printing. Every pair below was found by aligning the built text word by word
# against a second scan of the same setting (the 1900 printing,
# `evangelizationw00mottgoog`) and reading each difference; numerals, names and
# punctuation the two scans disagree on were settled on the page image.
# Classes: a letter misread ("Eome"/"Koman" for Rome/Roman, "Av" for w, "nn"
# for un, "tlie" for the), a wrong digit ("1873" for 1872, "$35,000" for
# $25,000), a closing quote read as "/'", the italic words the OCR garbled
# ("ohUgatio7i"), initials ("E. Q." for R. G.), a real word for another
# ("mouths" for months, "farther" for further), punctuation ("then is." for
# "then is,"), and the æ/œ ligatures the page sets ("Judæa", "Berœa").
BODY_CORRECTIONS.setdefault("evangelization-of-the-world", {}).setdefault("replacements", []).extend([
    # ch1
    ("their watchword. The Evangelization", "their watchword, The Evangelization"),
    ("whole creation;' when", "whole creation;\" when"),
    ("diflSculties", "difficulties"),
    ("jndge", "judge"),
    ("nnexpectant", "unexpectant"),
    # ch2
    ("Keflect", "Reflect"),
    ("hnndreds", "hundreds"),
    ("because we oive all", "because we owe all"),
    ("Eobert Stewart", "Robert Stewart"),
    ("generation; bnt,", "generation; but,"),
    ("tlie", "the"),
    ("equi|)ping", "equipping"),
    ("ohUgatio7i", "obligation"),
    ("Bnt the most serious", "But the most serious"),
    ("resurrection/ again", "resurrection, again"),
    ("the truth/' \"Why", "the truth.\" \"Why"),
    ("all the nations/' and", "all the nations,\" and"),
    # ch3
    ("non- Christian", "non-Christian"),
    ("evr.ngelical", "evangelical"),
    ("Avork", "work"),
    ("Avhich", "which"),
    ("Avhole", "whole"),
    ("Avilling", "willing"),
    ...
    ("Avithin", "within"),
    ("AVesleyan", "Wesleyan"),
    ("WatchAvord", "Watchword"),
    ("Koman", "Roman"),
    ("Kussia", "Russia"),
    ("Eoman", "Roman"),
    ("Eome", "Rome"),
    ("ontnnmbering", "outnumbering"),
    ("illiterate. lu India", "illiterate. In India"),
    ("diflficult", "difficult"),
    ("Church oti the", "Church on the"),
    ("indiiference", "indifference"),
    ("mind g,nd heart", "mind and heart"),
    ("Scrij)tures", "Scriptures"),
    ("Scrijture", "Scripture"),
    ("accomjjlishment", "accomplishment"),
    ("without hojje", "without hope"),
    ("employment/' Attention", "employment.\" Attention"),
    # ch4
    ("difi'ering", "differing"),
    ("Judsea", "Judæa"),
    ("Judasa", "Judæa"),
    ("Judaea", "Judæa"),
    ("Judgeo-Christian", "Judæo-Christian"),
    ("Samaria/'", "Samaria,\""),
    ("persecntion", "persecution"),
    ("spent in Home,", "spent in Rome,"),
    ("mnch", "much"),
    ("nnto", "unto"),
    ("jonrney", "journey"),
    ("in this citj.", "in this city."),
    ("prsetorian", "prætorian"),
    ("Eamsay", "Ramsay"),
    ("con-V verts", "converts"),
    ("Bercea", "Berœa"),
    ("Beroea", "Berœa"),
    ("Phoenicia", "Phœnicia"),
    ("not ouly", "not only"),
    ("PauFs", "Paul's"),
    ("eight mouths each", "eight months each"),
    ("ApoUos", "Apollos"),
    ("absolntely", "absolutely"),
    ("xnovement", "movement"),
    ("with tears/*", "with tears,\""),
    ("nnevangelized", "unevangelized"),
    # ch5
    ("Koss", "Ross"),
    ("Eoss", "Ross"),
    ("arrived in 1873", "arrived in 1872"),
    ("difi&amp;culty", "difficulty"),
    ("that *Hhe Gospel", "that \"the Gospel"),
    ("little farther on he entered", "little further on he entered"),
    ("far from 300,000 booklets", "far from 200,000 booklets"),
    ("offer of $35,000", "offer of $25,000"),
    ("chnrches", "churches"),
    ("missionarywork", "missionary work"),
    ("mnltiplied", "multiplied"),
    ("Eussian", "Russian"),
    ("Eeformed", "Reformed"),
    ("toTiole", "whole"),
    ("in the country/' As far", "in the country.\" As far"),
    ("in foreign mission service,", "in foreign mission service."),
    # ch6
    ("probable; bat the", "probable; but the"),
    ("onght", "ought"),
    ("Qneen", "Queen"),
    ("non-Christian iands.", "non-Christian lands."),
    ("Eailway", "Railway"),
    ("Kailway", "Railway"),
    ("-vW; The extension", "The extension"),
    ("cahle", "cable"),
    ("abont", "about"),
    ("inflnence", "influence"),
    ("Grospel", "Gospel"),
    ("liumber", "number"),
    ("$65,037,091,197.'", "$65,037,091,197.\""),
    ("Eegardless", "Regardless"),
    ("Kobert E. Speer", "Robert E. Speer"),
    ("tiian", "than"),
    ("over 11,100,000.", "over $1,100,000."),
    ("Dr. Oust", "Dr. Cust"),
    ("Ianguages", "languages"),
    ("nnmber", "number"),
    ("his Churches/' The Church", "his Churches.\" The Church"),
    # ch7
    ("Kespecting", "Respecting"),
    ("instructioti a7id", "instruction and"),
    ("Eecollect", "Recollect"),
    ("Christiatis", "Christians"),
    ("rests upon us 9 That", "rests upon us? That"),
    ("aU the natio7is9", "all the nations?"),
    ("1893-3", "1892-3"),
    ("if hut God's", "if but God's"),
    ("Spii'it", "Spirit"),
    ("for the worh,", "for the work,"),
    ("Kev.", "Rev."),
    ("Eev.", "Rev."),
    ("tiiirty", "thirty"),
    ("be bom in a day", "be born in a day"),
    ("Eobson", "Robson"),
    ("the name oS Christ", "the name of Christ"),
    ("go for us? *We appeal", "go for us?' We appeal"),
    ("to-night: *Is God dead?'", "to-night: 'Is God dead?'"),
    ("with fire/ so", "with fire,' so"),
    ("for a' Sanctuary", "for a 'Sanctuary"),
    ("for a dominion '\"", "for a dominion!'\""),
    ("Dr. J. C. K. Ewing", "Dr. J. C. R. Ewing"),
    ("Dr. E. Q. Wilder", "Dr. R. G. Wilder"),
    ("Walter K. Lambuth", "Walter R. Lambuth"),
    ("Mohammeds temple", "Mohammed's temple"),
    ("the most capable in action/'", "the most capable in action,\""),
    ("of the World/' says:", "of the World,\" says:"),
    # ch8
    ("mnst", "must"),
    ("sent ont.", "sent out."),
    ("grow np without", "grow up without"),
    ("raising np and", "raising up and"),
    ("traths", "truths"),
    ("eflBcient", "efficient"),
    ("Kafl&amp;rs", "Kaffirs"),
    ("woald", "would"),
    ("if ttie missionary", "if the missionary"),
    ("Martyu", "Martyn"),
    ("bottom of onr spiritless", "bottom of our spiritless"),
    ("geuerally", "generally"),
    ("Kedeemer", "Redeemer"),
    ("mis-, sionary", "missionary"),
    ("prayerf ulness", "prayerfulness"),
    # ch9
    ("nniversities", "universities"),
    ("Itheir]", "[their]"),
    ("instrnctive", "instructive"),
    ("nnseen", "unseen"),
    ("conld", "could"),
    ("inclnced", "induced"),
    ("diflQculties", "difficulties"),
    ("shonld", "should"),
    ("He mast give", "He must give"),
    ("I wonld not", "I would not"),
    ("Madagascar nnder", "Madagascar under"),
    ("to Greeks and to Barbarians/'", "to Greeks and to Barbarians,\""),
    # punctuation, settled on the page image
    ('Sub- Apostolic', 'Sub-Apostolic'),
    ('darkness steeped', 'darkness, steeped'),
    ('then is. Shall', 'then is, Shall'),
    ('Western Europe, Aggressive', 'Western Europe. Aggressive'),
    ('St, Peter', 'St. Peter'),
    ('once more however', 'once more, however'),
    ('charac ter', 'character'),
    ('interests* of', 'interests of'),
    ('several years* missionary', "several years' missionary"),
    ('cause of the worlds evangelization', "cause of the world's evangelization"),
    ('recessions of states with', 'recessions of states, with'),
    ('Tibet and Afghanistan, As late', 'Tibet and Afghanistan. As late'),
    ('ever known. Dr. Joel', 'ever known, Dr. Joel'),
    ('do His part. He will', 'do His part, He will'),
    ('Review said; ', 'Review said: '),
    ('the high. Scriptural', 'the high, Scriptural'),
    ('Mr, John', 'Mr. John'),
    ("individuals in every nation/' *", 'individuals in every nation."'),
    ("evangelizing Japan in this generation/'", 'evangelizing Japan in this generation."'),
    ('as alive from the dead/ and', "as alive from the dead,' and"),
    ('commission given by Christ."!', 'commission given by Christ."'),
    ('nearly $80000.', 'nearly $80,000.'),
    ('used to-day . Of', 'used to-day? Of'),
    ('ministry . of', 'ministry of'),
    ('population bnt also', 'population but also'),
    ('factor in i obtaining', 'factor in obtaining'),
    ('through the children, The fact', 'through the children. The fact'),
    # quotation marks, settled on the page image
    ('The "Word of God sets', 'The Word of God sets'),
    ('evangelization of the "world in this', 'evangelization of the world in this'),
    ('The "Word of God possesses', 'The Word of God possesses'),
    ('the "Watchword: "I wish', 'the Watchword: "I wish'),
    ("monasteries.' * It", 'monasteries." It'),
    ('Truth, — * Is God dead? I repeat', "Truth, — 'Is God dead?' I repeat"),
    ('cry, — *Lord, what', "cry, — 'Lord, what"),
    ("write: '*' A hundred", 'write: "A hundred'),
    ("belief that '* the millions", 'belief that "the millions'),
    ("*'The true value", '"The true value'),
    ("said he, *'on anything", 'said he, "on anything'),
    ("*'If I as a foreign", '"If I as a foreign'),
    ("he said, &lt;'I think", 'he said, "I think'),
    ('is linked," Lo I am', 'is linked, "Lo I am'),
    ('place how" the working', 'place how "the working'),
    ('1892-3: "Christ for India', '1892-3: "\'Christ for India'),
    ("the few. The Gospel to every creature'", "the few. 'The Gospel to every creature'"),
    ("divine command, Be ye perfect.'", "divine command, 'Be ye perfect.'"),
    ('with one voice, Lord, here am I', "with one voice, 'Lord, here am I"),
    ("to 'make disciples of all the nations; the extra", "to 'make disciples of all the nations;' the extra"),
    ('per cent,', 'per cent.'),
    ('His great Sacrifice/"', 'His great Sacrifice.\'"'),
    ('&gt;/ A disproportionately', 'A disproportionately'),
    ('[their] missionary/ policy', '[their] missionary policy'),
])
# The paragraph ended on a stop the OCR read as a comma.
BODY_CORRECTIONS["evangelization-of-the-world"]["paragraph_breaks"] = [
    ('foreign mission service.', 'In 1898 the members'),
]
...
# --- finney-memoirs: the 1876 Barnes/Oberlin scan, repaired against the others ---
#
...
# read as y ("conyerted"), R as E ("Eome", "Eev."), N as IST, G as Gr / G-, h as
# li, opening quotes as ^^, stray gutter marks, decorative drop caps ("'TTT'HEN"),
# printer's signature marks ("3*"), and the facsimile of a handwritten sermon
# outline read as text. Every repair was settled against the OTHER 1876 scans of
# the same printing - `memoirsofrevchar00finnuoft` for words (a word was replaced
# only where this scan reads a non-word and the witness a word, or by hand where
# both read words and the context decides: "hurst"/"burst", "Prom"/"From",
# "lie"/"he"), and all three (uoft + both Google scans) for punctuation (a mark
# changed only where at least two agree and none reads it as this scan does:
# "prayer and! conference", "converted there He was"). Blanked names, which the
# print sets as an initial and a long dash and the OCR mostly lost ("Squire W ,",
# "Judge Gr"), use one form throughout: "W——". The uoft scan also supplies pages
# 94-95, which this scan lost (the pair ending "cannot remember."). Nothing is
# reworded.
#
# Two lists, derived in ONE step from the raw scan to the stored text, so no pair
# rewrites another's output: book-wide single-word repairs first (every occurrence
# of the `old` token takes that repair), then contextual repairs, each `old`
# unique in the book. Proved by re-deriving the stored text from the raw scan for
# all 36 chapters (settled twice, identical).
_FINNEY_MEMOIRS_WORDS: list[tuple[str, str]] = [
    ('"Grive', '"Give'),
    ('"TT\'T\'HILE', 'WHILE'),
    ('"TTT\'HEN', 'WHEN'),
    ('"am', 'and'),
...
_FINNEY_MEMOIRS_PAIRS: list[tuple[str, str]] = [
    ...
    ('being brought, so', 'being brought so'),
    ('they , did', 'they did'),
    ...
    ('? 1 tried', '? I tried'),
    ('Squire W had', 'Squire W—— had'),
    ('put np my', 'put up my'),
    ('Squire W , seeing', 'Squire W——, seeing'),
    ('was, ^^ I', 'was, " I'),
    ('I \\ saw him', 'I saw him'),
    ...
    ('Squire W came', 'Squire W—— came'),
    ('Mr. W had', 'Mr. W—— had'),
    ('the office. Deacon B came', 'the office, Deacon B—— came'),
    ('Deacon B , I', 'Deacon B——, I'),
    ("said, '' What", 'said, " What'),
    ('Deacon B was', 'Deacon B—— was'),
    ('that G-od wanted', 'that God wanted'),
    ('of G-od and', 'of God and'),
    ('to make, any', 'to make any'),
    ('put m competition', 'put in competition'),
    ('to conyerse with any', 'to converse with any'),
    ('Mr. W , the shoemaker,', 'Mr. W——, the shoemaker,'),
    ("said, '^ Mr.", 'said, " Mr.'),
    ('<p>• I spoke', '<p>I spoke'),
    ...
    ('Mr. 0 , who had', 'Mr. C——, who had'),
    ('of M , living', 'of M——, living'),
    ...
    ('and haye .left your', 'and have left your'),
    ...
    ('of M . He', 'of M——. He'),
    ('Deacon M stood', 'Deacon M—— stood'),
    ('Deacon M began', 'Deacon M—— began'),
    ("Squire W ', in", "Squire W——', in"),
    ('pray. Yery soon', 'pray. Very soon'),
    ('Squire W heard', 'Squire W—— heard'),
    ('sinner neyer will', 'sinner never will'),
    ('Mr. W was', 'Mr. W—— was'),
    ('came, ^^ Squire W is', 'came, "Squire W—— is'),
    (': ^^I went', ': "I went'),
    ('Squire W— — pacing', 'Squire W—— pacing'),
    ('shout, ^ I', 'shout, I'),
    ('Squire W appeared', 'Squire W—— appeared'),
    ('Father T , as', 'Father T——, as'),
    ('Squire W took', 'Squire W—— took'),
    ('would haye a', 'would have a'),
    ("found, 'attended with", 'found, attended with'),
    ('of Grod shone', 'of God shone'),
    ('worshipped Grod except', 'worshipped God except'),
    ('prostrated Paul, on', 'prostrated Paul on'),
    (';</p><p>and the', '; and the'),
    ('calm. ^ I', 'calm. I'),
    ('with God. which', 'with God which'),
    ('praying ^^ without', 'praying without'),
    ('let Mm lead', 'let him lead'),
    ('in tlie highest', 'in the highest'),
    ('Squire W— — , and', 'Squire W——, and'),
    ('the night" This', 'the night." This'),
    ('through tlie same', 'through the same'),
    ('time T tried', 'time I tried'),
    ("replied, '^ Brother W , she", 'replied, "Brother W——, she'),
    ("me, '' Why,", 'me, " Why,'),
    ('there .was considerable', 'there was considerable'),
    ...
    ("sinful 'nature, and", 'sinful nature, and'),
    ('sin 3* \\ imputed', 'sin imputed'),
    ('elect haye first', 'elect have first'),
    ("the 'elect is", 'the elect is'),
    ('to .be an', 'to be an'),
    ...
    ('Miss G- , sister', 'Miss G——, sister'),
    ('lodgings, 1 accepted', 'lodgings, I accepted'),
    ("Miss Gr 's mouth", "Miss G——'s mouth"),
    ...
    ('of D , who', 'of D——, who'),
    ('and D saw', 'and D—— saw'),
    ("Mr. D as '^ a hard", 'Mr. D—— as "a hard'),
    ('notorious D ? His', 'notorious D——? His'),
    ('been used. Just then,', 'been used, just then,'),
    ('work. D soon', 'work. D—— soon'),
    ...
    ('of S , a', 'of S——, a'),
    ('Mrs. S rose', 'Mrs. S—— rose'),
    ("Mrs. S 's moving", "Mrs. S——'s moving"),
    ("said, '^ God", 'said, " God'),
    ('with loye —', 'with love —'),
    ('indispensable condi- • tion of', 'indispensable condition of'),
    ('prayer and! conference', 'prayer and conference'),
    ('much personal! conversation,', 'much personal conversation,'),
    ('few ^ years', 'few years'),
    ...
    ('of I repetition', 'of repetition'),
    ('this ;^oint. They', 'this point. They'),
    ('seldom occurred,</p>', 'seldom occurred.</p>'),
    ('subject. \'^ Ministers,"', 'subject. " Ministers,"'),
    ('of language," Of', 'of language." Of'),
    ('toward mybrethren for', 'toward my brethren for'),
    ('different opinion., I', 'different opinion. I'),
    ...
    ("said, '' If", 'said, " If'),
    ("that ^' God", 'that " God'),
    ('Mr. P , a rich', 'Mr. P——, a rich'),
    ('Mr. 0 , who kept tlie village', 'Mr. C——, who kept the village'),
    ('Deacon E , as', 'Deacon R——, as'),
    ('Mrs. 0 , the', 'Mrs. C——, the'),
    ('Mrs. H , the wife', 'Mrs. H——, the wife'),
    ('Mrs. E , the', 'Mrs. R——, the'),
    ('Mrs. H agreed', 'Mrs. H—— agreed'),
    ('time in. prayer.', 'time in prayer.'),
    ('Mr. 0 , the', 'Mr. C——, the'),
    ...
    ('deacon W , elder', 'deacon W——, elder'),
    ('he, "I^was then', 'he, "I was then'),
    ('Deacon R from', 'Deacon R—— from'),
    ...
    ('Dr. S , an', 'Dr. S——, an'),
    ('Dr. S , at', 'Dr. S——, at'),
    ('Dr. S stepped', 'Dr. S—— stepped'),
    ('he tad but', 'he had but'),
    ('him, ^^ Doctor,', 'him, " Doctor,'),
    ('matter?" \'^Nothing," was', 'matter?" "Nothing," was'),
    ("him, '^ Doctor,", 'him, " Doctor,'),
    ...
    ('Mr. S , you', 'Mr. S——, you'),
    ('Mrs. S introduced', 'Mrs. S—— introduced'),
    ("him, '' Mr. S , I", 'him, " Mr. S——, I'),
    ('given ua certain', 'given us certain'),
    ('"Yes," J said. ^^What, according', '"Yes," I said. "What, according'),
    ('God." \'\'Yes/\' I', 'God." "Yes," I'),
    ('created ns with ft sinful', 'created us with a sinful'),
    ('Mr. S , have', 'Mr. S——, have'),
    ('not belieye any', 'not believe any'),
    ("<p>'^Mr. S , there", '<p>"Mr. S——, there'),
    ('was Y converted', 'was converted'),
    ('meeting • and', 'meeting and'),
    ('Mrs. S came', 'Mrs. S—— came'),
    ('Mr. S come', 'Mr. S—— come'),
    ('he, •" as', 'he, " as'),
    ('Mr. S , and', 'Mr. S——, and'),
    ...
    ('Mr. S .</p>', 'Mr. S——.</p>'),
    ('they J were', 'they were'),
    ('faith _ and', 'faith and'),
    ('Mr. S gave', 'Mr. S—— gave'),
    ('of B H , and', 'of B—— H——, and'),
    ('this B H . "Oh', 'this B—— H——. "Oh'),
    ('Mr. S ! he', 'Mr. S——! he'),
    ('and B H die,', 'and B—— H—— die,'),
    ('and B H in', 'and B—— H—— in'),
    ('Mr. S , "just', 'Mr. S——, "just'),
    ('and B H go', 'and B—— H—— go'),
    ('This B H was', 'This B—— H—— was'),
    ("Mr. S 's lived", "Mr. S——'s lived"),
    ('Mr.</p><p>M , who', 'Mr. M——, who'),
    ("Mr. S 's, rose", "Mr. S——'s, rose"),
    ('Mr. M had', 'Mr. M—— had'),
    ('good.</p><p>\\</p>', 'good.</p>'),
    ...
    ('Mr. F , of', 'Mr. F——, of'),
    ('Mr. F spent', 'Mr. F—— spent'),
    ('of B , was', 'of B——, was'),
    ('of F , called', 'of F——, called'),
    ('Squire F had', 'Squire F—— had'),
    ('Mr. F— — , however,', 'Mr. F——, however,'),
    ('a Eoman Catholic,', 'a Roman Catholic,'),
    ('an elder S , who was', 'an elder S——, who was'),
    ('Mr. F .</p>', 'Mr. F——.</p>'),
    ("Mr. S 's son,", "Mr. S——'s son,"),
    ('Elder S attended', 'Elder S—— attended'),
    ('elder B to', 'elder B—— to'),
    ('Elder B was', 'Elder B—— was'),
    ('to elder S , who was', 'to elder S——, who was'),
    ('Elder S was', 'Elder S—— was'),
    ('elder S said', 'elder S—— said'),
    ("elder B , *^'How did", 'elder B——, " How did'),
    ('Elder B replied,', 'Elder B—— replied,'),
    ...
    ('a Eoman Catholic ;', 'a Roman Catholic ;'),
    ("he, ^'^ I", 'he, " I'),
    ('elder S returned', 'elder S—— returned'),
    ('down to-the synod', 'down to the synod'),
    ('found myself, saying', 'found myself saying'),
    ('to me.</p><p>aud how', 'to me, and how'),
    ('Western Eevivals." So', 'Western Revivals. " So'),
    ('Oneida Associa tion," who,', 'Oneida Association," who,'),
    ('Their leader. Rev.', 'Their leader, Rev.'),
    ...
    ('answer had, been', 'answer had been'),
    ('I . arose', 'I arose'),
    ('showed tliem up,', 'showed them up,'),
    ("and XJoilE^iJiJ' t, th^_spii±LiiLp3:ay©r-w jng^especially among^the^emal^-members-^oi-the church: Mrs. B and", 'and I found that the spirit of prayer was prevailing, especially among the female members of the church. Mrs. B—— and'),
    ('Mrs. H , the wives', 'Mrs. H——, the wives'),
    ('Mrs. H , however,', 'Mrs. H——, however,'),
    ("Mr.</p><p>H 's, and", "Mr. H——'s, and"),
    ...
    ('Miss H , one', 'Miss H——, one'),
    ('them np to', 'them up to'),
    ('Miss H came', 'Miss H—— came'),
    ('Miss H was', 'Miss H—— was'),
    ...
    ('the -^ means', 'the means'),
    ('secure the. conversion', 'secure the conversion'),
    ('rose v>^^ suddenly', 'rose suddenly'),
    ('said, ^^ Now', 'said, " Now'),
    ('of W , a', 'of W——, a'),
    ("Mr. H 's store,", "Mr. H——'s store,"),
    ('Mr. W , to', 'Mr. W——, to'),
    ('so fall of', 'so full of'),
    ('Mr. F , a', 'Mr. F——, a'),
    ('Mr. Grillett said,', 'Mr. Gillett said,'),
    ("Mr. F 's dining-room.", "Mr. F——'s dining-room."),
    ('Little H , a', 'Little H——, a'),
    ('madness." ISTevertheless the', 'madness." Nevertheless the'),
    ('little H , and', 'little H——, and'),
    ('little H to', 'little H—— to'),
    (';</p><p>and both', '; and both'),
    ('known, Grod did', 'known, God did'),
    ('ridicule fche work', 'ridicule the work'),
    ('Mr. H , who', 'Mr. H——, who'),
    ('Mr. H was present', 'Mr. H—— was present'),
    ('Mr. H remarked, ^^ Gentlemen,', 'Mr. H—— remarked, " Gentlemen,'),
    ('he, ^^ there', 'he, " there'),
    ('Mr. H had', 'Mr. H—— had'),
    ('Mr. H has', 'Mr. H—— has'),
    ('Mr. H himself.', 'Mr. H—— himself.'),
    ('Mr. H was one', 'Mr. H—— was one'),
    ('sheriff, B by', 'sheriff, B—— by'),
    ('at Eome ;', 'at Rome ;'),
    ('for Mm to', 'for him to'),
    ('that lie was glad', 'that he was glad'),
    ("Mr. F 's hotel,", "Mr. F——'s hotel,"),
    ('at Eome again.', 'at Rome again.'),
    ('with lio instance', 'with no instance'),
    ('at Eome at', 'at Rome at'),
    ('remark. ^^ I', 'remark. " I'),
    ('prayer * of', 'prayer of'),
    ('of prominent, influence', 'of prominent influence'),
    ('spent the-night. It', 'spent the night. It'),
    ('hope in- Christ,', 'hope in Christ,'),
    ('her. Soon, after', 'her. Soon after'),
    ...
    ('Mr. B , the sheriff', 'Mr. B——, the sheriff'),
    ('Mr. B had', 'Mr. B—— had'),
    ('I obseryed Mr. B rise', 'I observed Mr. B—— rise'),
    ...
    ('of them,, assuring', 'of them, assuring'),
    ...
    ('Mr.</p><p>Weeks,', 'Mr. Weeks,'),
    ('Miss F T , from', 'Miss F—— T——, from'),
    ('Miss T , among', 'Miss T——, among'),
    ('of B T . She', 'of B—— T——. She'),
    ('who B T was,', 'who B—— T—— was,'),
    ('Mr. T ^ naming', 'Mr. T——, naming'),
    ('Mr. T waited', 'Mr. T—— waited'),
    ('Mr. T of', 'Mr. T—— of'),
    ('Mr. W , an', 'Mr. W——, an'),
    ('Mr. G- A', 'Mr. G—— A'),
    ('at fche machinery,', 'at the machinery,'),
    ('Mr. W , the owner', 'Mr. W——, the owner'),
    ...
    ("out, '' Name", 'out, " Name'),
    ('<p>j There', '<p>There'),
    ('of H , residing', 'of H——, residing'),
    ('Mrs. H was', 'Mrs. H—— was'),
    ('Mr. H , of', 'Mr. H——, of'),
    ('sat and. held', 'sat and held'),
    ('Mr. H to', 'Mr. H—— to'),
    ...
    ('Judge C , who', 'Judge C——, who'),
    ('that ho was', 'that he was'),
    ('gone, Eev. Horatio', 'gone, Rev. Horatio'),
    ('Mr. S— — , cashier', 'Mr. S——, cashier'),
    ("said, ^' Pray", 'said, " Pray'),
    ('wealthy, unconyerted man.', 'wealthy, unconverted man.'),
    ('Mr. S was', 'Mr. S—— was'),
    ('Judge C who', 'Judge C—— who'),
    ('Miss S , from', 'Miss S——, from'),
    ('Miss S — to', 'Miss S—— to'),
    ("Miss S 's father", "Miss S——'s father"),
    ('Miss S first', 'Miss S—— first'),
    ('Miss S came', 'Miss S—— came'),
    ('a Dr.W , who', 'a Dr. W——, who'),
    ('Miss S , and', 'Miss S——, and'),
    ('Mr. T , a', 'Mr. T——, a'),
    ("text, '^ The", 'text, " The'),
    ('Rev. J B and', 'Rev. J—— B—— and'),
    ('Mr.</p><p>0 . Mr. 0 was', 'Mr. C——. Mr. C—— was'),
    ('Mr. B was', 'Mr. B—— was'),
    ('Mr. B , informing', 'Mr. B——, informing'),
    ...
    ('sustain him When', 'sustain him. When'),
    (': ^^ We have', ': " We have'),
    ...
    ('publish it Here', 'publish it. Here'),
    ...
    ('days. 10*</p>', 'days.</p>'),
    ('of S , from', 'of S——, from'),
    ('Mr. B , who had', 'Mr. B——, who had'),
    ('Miss S , of', 'Miss S——, of'),
    ('Miss S met', 'Miss S—— met'),
    ('horse ? " "0 yes ! "', 'horse ? " "O yes ! "'),
    ('replied, ^^ perfectly', 'replied, " perfectly'),
    ("Mr. S 's, the", "Mr. S——'s, the"),
    ('Miss S — —whom I', 'Miss S——whom I'),
    ("Mr. S 's, and", "Mr. S——'s, and"),
    ('Judge P , that', 'Judge P——, that'),
    ('Miss S stepped', 'Miss S—— stepped'),
    ('Judge P . Her', 'Judge P——. Her'),
    ('Miss S seemed', 'Miss S—— seemed'),
    ('Miss S . The', 'Miss S——. The'),
    ('text, *^ God', 'text, " God'),
    ('of J , a', 'of J——, a'),
    ...
    ('Mr. P as', 'Mr. P—— as'),
    ('of M ; which', 'of M——; which'),
    ('Mr. B , their', 'Mr. B——, their'),
    ('this M family,', 'this M—— family,'),
    ('Mr. B , that', 'Mr. B——, that'),
    ('Mr.</p><p>B died', 'Mr. B—— died'),
    ('Miss S of', 'Miss S—— of'),
    ('<p>^" As', '<p>As'),
    ('</p><p>\\*v..</p>', '</p>'),
    ...
    ('I was. licensed', 'I was licensed'),
    ('all KEVIVAL AT PHILADELPHIA. Ml occasions,', 'all occasions,'),
    ('they must, hold', 'they must hold'),
    ...
    ('years. "^ But', 'years. But'),
    ('pastor, requested, me', 'pastor, requested me'),
    (';</p><p>and now', '; and now'),
    ...
    ("many '^ the", 'many " the'),
    ('was a. large', 'was a large'),
    ("These 'men that", 'These men that'),
    ...
    ("once, '^ I", 'once, " I'),
    ('Mr. B , whose', 'Mr. B——, whose'),
    ("Mr. O'B himself", "Mr. O'B—— himself"),
    ("Mr. O'B could", "Mr. O'B—— could"),
    ('Mr. O\'B , "Give', 'Mr. O\'B——, "Give'),
    ("me, '^Do you", 'me, " Do you'),
    ("know him ?^' I", 'know him?" I'),
    ("said, '^ Yes,", 'said, " Yes,'),
    ('Dr. M , or', 'Dr. M——, or'),
    ('Dr. M himself.', 'Dr. M—— himself.'),
    ...
    ('woman ? " "0 yes ! "', 'woman ? " "O yes ! "'),
    ('her j " meaning,', 'her ;" meaning,'),
    ("family. ^' Well,", 'family. " Well,'),
    ('I. \'^ 0," said', 'I. " O," said'),
    ('character?" "0 yes!"', 'character?" "O yes!"'),
    ('Mr. W , a leading', 'Mr. W——, a leading'),
    ('conversation in. regard', 'conversation in regard'),
    ('Mr. W , proposed', 'Mr. W——, proposed'),
    ('Mr. Einney are', 'Mr. Finney are'),
    ('to Eev.</p><p>Mr. P , Unitarian', 'to Rev. Mr. P——, Unitarian'),
    ('Mr. W — • — had', 'Mr. W—— had'),
    ('Mr. P , accordingly,', 'Mr. P——, accordingly,'),
    ('at Eochester were', 'at Rochester were'),
    ('the subject^ nntil I', 'the subject, until I'),
    (': ^^ Ah !', ': "Ah !'),
    ('all "was rights you', 'all was right, you'),
    ('going. 1 felt', 'going. I felt'),
    ('that Eochester was', 'that Rochester was'),
    ('in Eochester early', 'in Rochester early'),
    ('my cousin,, Mr. S , in', 'my cousin, Mr. S——, in'),
    ('Mr. S exerted', 'Mr. S—— exerted'),
    ...
    ('think again. Dr.', 'think again, Dr.'),
    ('morning T recollect', 'morning I recollect'),
    ('Mr. B , the son', 'Mr. B——, the son'),
    ('of A B , then', 'of A—— B——, then'),
    ('Mr.</p><p>B was', 'Mr. B—— was'),
    ('Miss A was his', 'Miss A—— was his'),
    ('Miss A was a', 'Miss A—— was a'),
    ('Mr.</p><p>B ■ found', 'Mr. B—— found'),
    ('Miss A , and', 'Miss A——, and'),
    ('Mr.</p><p>B himself', 'Mr. B—— himself'),
    ('years since. Miss A informed', 'years since, Miss A—— informed'),
    ('Mr.</p><p>B , a', 'Mr. B——, a'),
    ('to Grod." \'\' What', 'to God." \' \' What'),
    ('said, ^^I am', 'said, "I am'),
    ('other .there. We', 'other there. We'),
    ('that lie was unable', 'that he was unable'),
    ('Deacon P , of', 'Deacon P——, of'),
    ('Deacon T , of', 'Deacon T——, of'),
    ('Deacon B , of', 'Deacon B——, of'),
    ('women, 13* the', 'women, the'),
    ('with ajawyer, who', 'with a lawyer, who'),
    ('Mr. P , a prominent', 'Mr. P——, a prominent'),
    ('Mr. P was', 'Mr. P—— was'),
    ('him, ** Do you', 'him, "Do you'),
    ('God ? " "0 yes ! "', 'God ? " "O yes ! "'),
    ('atheist." ^^Well, do', 'atheist." "Well, do'),
    ('<p>Have, you', '<p>Have you'),
    ('" ^^0 yes', '" "O yes'),
    ("answered, ''I cannot", 'answered, "I cannot'),
    ('"after 1 left', '"after I left'),
    ('churches throughout, sev eral states,', 'churches throughout several states,'),
    ('to witnes? the', 'to witness the'),
    ('converted there He', 'converted there. He'),
    ('The pastor. Rev.', 'The pastor, Rev.'),
    ...
    ('Mr. T S , a', 'Mr. T—— S——, a'),
    ('-Justice S . He', '-Justice S——. He'),
    ("Mr. S 's, I", "Mr. S——'s, I"),
    ("said, ^'Mr. Finney,", 'said, "Mr. Finney,'),
    ('years since. Dr. S , of', 'years since, Dr. S——, of'),
    ('were hopefully conyerted.</p><p>The', 'were hopefully converted.</p><p>The'),
    ('Mr. H , the', 'Mr. H——, the'),
    ('of Eev. Dr. H , of', 'of Rev. Dr. H——, of'),
    ('sinner\'s ^\'cannot" is', 'sinner\'s "cannot" is'),
    ('his \'^will not,"', 'his " will not,"'),
    ('Mr. H rebelled', 'Mr. H—— rebelled'),
    ("Mr. H 's opposition", "Mr. H——'s opposition"),
    ("called ^' the", 'called " the'),
    (';</p><p>that', '; that'),
    ('was, *^^Lord, do', 'was, "Lord, do'),
    ('a useful. Christian', 'a useful, Christian'),
    ("called '^sl protracted", 'called "a protracted'),
    ('which Eev. Dr.', 'which Rev. Dr.'),
    (';</p><p>and several', '; and several'),
    ('Josiah Ohapin ;', 'Josiah Chapin ;'),
    ('Miss A , brother', 'Miss A——, brother'),
    ('conviction . that', 'conviction that'),
    ('me, ** Mr.', 'me, " Mr.'),
    ('she, ^^ I see', 'she, " I see'),
    ...
    ('of H . Mr. H was a', 'of H——. Mr. H—— was a'),
    ('Mr. H . The', 'Mr. H——. The'),
    ('Mr. H came', 'Mr. H—— came'),
    ('happened, lie sat', 'happened, he sat'),
    ('Mr. H afterwards', 'Mr. H—— afterwards'),
    ('Mr. H himself relate', 'Mr. H—— himself relate'),
    ('Mr. H expressed', 'Mr. H—— expressed'),
    ('it, ^^he held', 'it, "he held'),
    ('Mr. H among', 'Mr. H—— among'),
    ('Mr. H was either', 'Mr. H—— was either'),
    ('the cliurclies, and', 'the elm relies, and'),
    ('with ns, and', 'with us, and'),
    ('us, which, called', 'us, which called'),
    ...
    ('interested lin the .question, offered,', 'interested in the question, offered,'),
    ...
    ('would Just \\ as soon. send', 'would just as soon send'),
    ('; — ^Mr. Willard', '; Mr. Willard'),
    ('we disabused the', 'we dis abused the'),
    ('the Lord, was', 'the Lord was'),
    ('our own, that', 'our own that'),
    ("preserved '^ the", 'preserved " the'),
    ('of harmony. Christian', 'of harmony, Christian'),
    ('the stateof public', 'the state of public'),
    ('mentioned 1 that', 'mentioned that'),
    ('in >; the', 'in the'),
    ('state, and. that', 'state, and that'),
    ...
    ('mistake not many', 'mistake not, many'),
    ('part oi the', 'part of the'),
    ('<p>at Beside,', '<p>Beside,'),
    ('Dr. 0 . Hearing', 'Dr. C——. Hearing'),
    ('Dr. 0 , as', 'Dr. C——, as'),
    ("Dr.</p><p>C 's name", "Dr. C——'s name"),
    ('was "mentioned, and', 'was mentioned, and'),
    ('emotion, ^^ I', 'emotion, " I'),
    ("to heayen I ''</p>", 'to heaven I "</p>'),
    ('Judge G called', 'Judge G—— called'),
    ('Sarah B , of', 'Sarah B——, of'),
    ('Judge G had', 'Judge G—— had'),
    ('Judge Gr was', 'Judge G—— was'),
    ("question: '* Do we", 'question: "Do we'),
    ("Judge G 's wife", "Judge G——'s wife"),
    ('Mr. Pinney, I', 'Mr. Finney, I'),
    ('Judge G- , at', 'Judge G——, at'),
    ('Judge G was', 'Judge G—— was'),
    ('Judge Gr had', 'Judge G—— had'),
    ('Judge G- . He', 'Judge G——. He'),
    ('Judge G , as', 'Judge G——, as'),
    ('Judge G , I', 'Judge G——, I'),
    ("remarking, ^' I", 'remarking, " I'),
    ('<p>f He appeared', '<p>He appeared'),
    ('not _go^ farther', 'not go farther'),
    ('<p>Tlie measures', '<p>The measures'),
    ('Christ. They, were', 'Christ. They were'),
    ('God wastrying to', 'God was trying to'),
    ('expressly, ^ that', 'expressly, that'),
    ('believe, ,to submit,', 'believe, to submit,'),
    ('always in-your public', 'always in your public'),
    ('discourses \\ carry', 'discourses carry'),
    ("my 'lieart does", 'my heart does'),
    ...
    ('an ; exposition', 'an exposition'),
    ('to j the', 'to the'),
    ('Mr. I Miller', 'Mr. Miller'),
    ...
    ('praying, earnest. Christian', 'praying, earnest, Christian'),
    ('of S had', 'of S—— had'),
    (": '' Now", ': " Now'),
    ...
    ('perfectly willing.</p><p>to', 'perfectly willing, to'),
    ...
    ('Deacon P and', 'Deacon P—— and'),
    ('Deacon S , after', 'Deacon S——, after'),
    ('of tlie pulpit,', 'of the pulpit,'),
    ("replied, ''I do", 'replied, "I do'),
    ('to haye those', 'to have those'),
    ('sight ol As', 'sight of. As'),
    ('to ma that', 'to me that'),
    ('thus addressed.. It', 'thus addressed. It'),
    ...
    ('writing tome, to', 'writing to me, to'),
    ('in tlie village', 'in the village'),
    ('persons, .scattered over', 'persons, scattered over'),
    ...
    ('the crowd,, and', 'the crowd, and'),
    ('people. *^Why," said', 'people. "Why," said'),
    ("this, ^^I don't", 'this, "I don\'t'),
    ('the impression, that (lod^coinniandstMni, now', 'the impression that God commands them, now'),
    ('I . seldom', 'I seldom'),
    ...
    ('about Manchester, In', 'about Manchester. In'),
    ('Mr. J BHe belonged', 'Mr. J—— B——. He belonged'),
    ('piety, yery unsectarian', 'piety, very unsectarian'),
    ("replied, '^ I", 'replied, " I'),
    ('Mr. Bcame into', 'Mr. B—— came into'),
    ('Mrs. B herself', 'Mrs. B—— herself'),
    ('remarks. J did', 'remarks. I did'),
    ('tried ito impress', 'tried to impress'),
    ('if per-^ mitted, to', 'if permitted, to'),
    ('interested. . I', 'interested. I'),
    ('much engaged,, and', 'much engaged, and'),
    ('Brother B had', 'Brother B—— had'),
    ('Brother B- — ■ still', 'Brother B—— still'),
    ...
    (': ^^But seek', ': " But seek'),
    ('" rU go it', '" I\'ll go it'),
    ('denominations. . As', 'denominations. As'),
    ('grief, T heard', 'grief, I heard'),
    ('brethren would, work', 'brethren would work'),
    ...
    ('The "responsibilities of', 'The responsibilities of'),
...
# --- christ-the-healer: the 1924 Archive scan's OCR --------------------------------
# The first edition (1924), built by `build_christ_the_healer` from the Internet
# Archive scan of Princeton Theological Seminary's copy. Every pair below repairs
# what the OCR got wrong and was settled word by word against two more scans of
# the same plates; none rewrites Bosworth. The printed text's own slips are kept
# ("disposed to to show", "too intense to to describe", "opthalmia").
BODY_CORRECTIONS.setdefault("christ-the-healer", {}).setdefault("replacements", []).extend([
    # A word the scan misread. Read against the two witnesses — Phillips
    # Academy's copy of the same printing (christhealerserm0000fred) and the
    # first printing (christhealerserm0000evag) — and, where all three OCRs
    # share an engine's slip (3/8, h/li, italic I read as J/T/7), the page.
    ("an ordi-—nance,", "an ordinance,"),
    ("curse was re-moved by", "curse was removed by"),
    ("the lifting up of Christ. (Galatians 3:18)", "the lifting up of Christ. (Galatians 3:13)"),
    ("Now, in Galatians 3:18, we have", "Now, in Galatians 3:13, we have"),
    ("The Rev. Daniel Bryant, in’ his", "The Rev. Daniel Bryant, in his"),
    ("JEHOVAH-SHALOM—tThe Lord", "JEHOVAH-SHALOM—The Lord"),
    ("typical of our re-. demption,", "typical of our redemption,"),
    ("Since Jehovah' Rapha is", "Since Jehovah-Rapha is"),
    ("4th verse of Isaiah 538,", "4th verse of Isaiah 53,"),
    ("the 58rd of Isaiah", "the 53rd of Isaiah"),
    ("from me to Gal- —vary—salvation", "from me to Calvary—salvation"),
    ("to exclude RCE from any of these. blessings.", "to exclude ourselves from any of these blessings."),
    ("bore its curse,'and therefore", "bore its curse, and therefore"),
    ("with Calvary, there' fore we", "with Calvary, therefore we"),
    ("both a itual and bodily", "both spiritual and bodily"),
    ("take away ali that", "take away all that"),
    ("cancelled his “7f,’’ adding", "cancelled his “if,” adding"),
    ("that it zs God’s will", "that it is God’s will"),
    ("He has cllotted to man", "He has allotted to man"),
    ("I want you to recallthat", "I want you to recall that"),
    ("healing all manner of sieknesses,", "healing all manner of sicknesses,"),
    ("(St. John 14:12, 18.)", "(St. John 14:12, 13.)"),
    ("8. His present attitude is revealed by His own fulfilment", "3. His present attitude is revealed by His own fulfilment"),
    ("All the other sick veople", "All the other sick people"),
    ("the darker dispénsation?", "the darker dispensation?"),
    ("How ean God justify", "How can God justify"),
    ("Sincg our inheritance", "Since our inheritance"),
    ("The Greek word ‘“‘sogo”", "The Greek word “sozo”"),
    ("Both Greek words fer “salvation”", "Both Greek words for “salvation”"),
    ("A Suggestive Comparisow", "A Suggestive Comparison"),
    ("the doctrine of heal_ing;", "the doctrine of healing;"),
    ("slow to anger, and ef great mercy", "slow to anger, and of great mercy"),
    ("These sentiments con-~ cerning", "These sentiments concerning"),
    ("He is disposed to te show favors", "He is disposed to to show favors"),
    ("so floods owr hearts", "so floods our hearts"),
    ("And J esus, moved", "And Jesus, moved"),
    ("not only the game in character", "not only the same in character"),
    ("itself constantly con-fronts them", "itself constantly confronts them"),
    ("“full of merey”", "“full of mercy”"),
    ("a few of the _ gtatements made", "a few of the statements made"),
    ("departing © from evil, “Zt shall", "departing from evil, “It shall"),
    ("(I Cor. 6:20.) “TI beseech", "(I Cor. 6:20.) “I beseech"),
    ("becomes His property ae He promises", "becomes His property that He promises"),
    ("commission, and, dastay to the Great", "commission, and, lastly to the Great"),
    ("—Bryant.</p><p>“Tf the Spirit", "—Bryant.</p><p>“If the Spirit"),
    ("Who is the MiracleWorker,", "Who is the Miracle-Worker,"),
    ("their reason con expecting", "their reason for expecting"),
    ("How all-sufficient 1s this reason", "How all-sufficient is this reason"),
    ("when you pray for haatine Christ", "when you pray for healing Christ"),
    ("Thy loving kindness ts better", "Thy loving kindness is better"),
    ("Harriet 8. Bainbridge says", "Harriet S. Bainbridge says"),
    ("Again, Josnua,", "Again, Joshua,"),
    ("“Satan’s angel,” ete.", "“Satan’s angel,” etc."),
    ("imparted co him is a man powerfui", "imparted to him is a man powerful"),
    ("the grace ot God given him made his very buffet- —ings", "the grace of God given him made his very buffetings"),
    ("bloody sweat ot Gethsemane", "bloody sweat of Gethsemane"),
    ("to work together tor his good", "to work together for his good"),
    ("has not Jearned", "has not learned"),
    ("grace to our bedies. ‘The very word “srace”", "grace to our bodies. The very word “grace”"),
    ("which Paul says, in ais case,", "which Paul says, in his case,"),
    ("In other words, “erace” is for", "In other words, “grace” is for"),
    ("But throughout his- © tory He", "But throughout history He"),
    ("one coula think of", "one could think of"),
    ("says this was his haus Why", "says this was his “thorn.” Why"),
    ("for all of Hee buffetings", "for all of these buffetings"),
    ("it is believed Sy many saad men,", "it is believed by many good men,"),
    ("tormenting che bodies", "tormenting the bodies"),
    ("the Episcovalian Commission", "the Episcopalian Commission"),
    ("element of the Gospei.", "element of the Gospel."),
    ("with their *repiisive discharges,”", "with their “repulsive discharges,”"),
    ("This heathen crippie had", "This heathen cripple had"),
    ("is it rot marvelous", "is it not marvelous"),
    ("unto Hlyricum ?” (Reon Again,", "unto Illyricum?” (Rom. 15:18, 19.) Again,"),
    ("between miracles and healine", "between miracles and healing"),
    ("Evangelist F. F. Bosworth ia the Alliance", "Evangelist F. F. Bosworth in the Alliance"),
    ("conclude, bcause of", "conclude, because of"),
    ("Would not Pavzl’s failure", "Would not Paul’s failure"),
    ("Souls saved and hodies healed", "Souls saved and bodies healed"),
    ("so precious tome.", "so precious to me."),
    ("the doctors said. JI had no control", "the doctors said. I had no control"),
    ("thank God—lI refused", "thank God—I refused"),
    ("twelve cents. JI asked", "twelve cents. I asked"),
    ("for relief. JI am sure", "for relief. I am sure"),
    ("Bosworth Brothers eame to see me", "Bosworth Brothers came to see me"),
    ("two biocks away.</p><p>One aay last", "two blocks away.</p><p>One day last"),
    ("It was 2 mass of blood", "It was a mass of blood"),
    ("never expected to seé her", "never expected to see her"),
    ("our hearts te Him right", "our hearts to Him right"),
    ("peace and joy that I rave in my", "peace and joy that I have in my"),
    ("her?” JI nodded", "her?” I nodded"),
    ("got up, zte breakfast", "got up, ate breakfast"),
    ("she returned’in the afternoon", "she returned in the afternoon"),
    ("that Jesus healea all", "that Jesus healed all"),
    ("could finish theiz course", "could finish their course"),
    ("all their iniquities wnto a land", "all their iniquities unto a land"),
    ("the whole rehearsa: without", "the whole rehearsal without"),
    ("“with giadness and joyfulness", "“with gladness and joyfulness"),
    ("The coudition of heart", "The condition of heart"),
    ("perfectly wcll, had on", "perfectly well, had on"),
    ("in any way Hechooses. Weare thankful", "in any way He chooses. We are thankful"),
    ("it was true. Hecould not", "it was true. He could not"),
    ("next night. Isat right", "next night. I sat right"),
    ("him? Itis the Scriptures", "him? It is the Scriptures"),
    ("had given ittome. Ido not", "had given it to me. I do not"),
    ("with two dollars init.", "with two dollars in it."),
    ("praise God, Ican run.", "praise God, I can run."),
    ("not His will todo?", "not His will to do?"),
    ("study and investigacion.", "study and investigation."),
    ("and He shcathed, as it were", "and He sheathed, as it were"),
    ("whether it was physieal or", "whether it was physical or"),
    ("Woodstock, IIl., May", "Woodstock, Ill., May"),
    ("Eberhart avenue.—lI visited", "Eberhart avenue.—I visited"),
    ("to change God’s “I Am” to “T Was", "to change God’s “I Am” to “I Was"),
    ("to say, “T can do no more for you,”", "to say, “I can do no more for you,”"),
    ("If he should go further, and say, “T will give", "If he should go further, and say, “I will give"),
    ("were per-. fectly straight", "were perfectly straight"),
    ("as the phySicians gave", "as the physicians gave"),
    ("Qne writer inquiries", "One writer inquiries"),
    ("full of-compassion.”", "full of compassion.”"),
    ("Jesus*healed all diseases", "Jesus healed all diseases"),
    ("JEHOVAH-SHAMMAH—*\"The Lord is there,” —or present", "JEHOVAH-SHAMMAH—“The Lord is there,” or present"),
    ("Matthew 8:16,17,—*\" . . . and He cast", "Matthew 8:16,17,—“ . . . and He cast"),
    ("(See I Thes,. 2: 12; Prov.", "(See I Thes. 2:12; Prov."),
    ("(Psalms 107 :20)", "(Psalms 107:20)"),
    ("Christ .was the Offering", "Christ was the Offering"),
    ("Miss Elizabeth Taylor, i fell", "Miss Elizabeth Taylor, I fell"),
    ("Testimony</h3><p>IT am well", "Testimony</h3><p>I am well"),
    ("of it. 1 received letters", "of it. I received letters"),
    ("The Scriptures mever speak", "The Scriptures never speak"),
    ("to be rid of “‘thim’’", "to be rid of “him”"),
    ("the promise of God as 7f it saw", "the promise of God as if it saw"),
    ("Since it is owr sicknesses He bore", "Since it is our sicknesses He bore"),
    ("“only owr sickness did He bear,”", "“only our sickness did He bear,”"),
    ("that it is owr sicknesses, as well", "that it is our sicknesses, as well"),
    ("“He hath redeemed ws (ail of us)", "“He hath redeemed us (all of us)"),
    ("by saying, “J will, be thou clean.”", "by saying, “I will, be thou clean.”"),
    ("in My name that will J do,", "in My name that will I do,"),
    ("healed of total deafmess", "healed of total deafness"),
    ("<h3>Heaurxsc or Nervous Breax-Down Resutrs 1x SauvatTion oF Hussanp anp Turee Davcurers</h3>", "<h3>Healing of Nervous Break-Down Results in Salvation of Husband and Three Daughters</h3>"),
    ("healed by ‘faith in Cod.”", "healed by “faith in God.”"),
    # The Princeton copy's pencil notes, stamp smudges and page specks read as
    # text ("return 4 ; { } hes ;", "He +t", "_", "©", "~"), and ellipses
    # the scan broke (". .."). Neither witness prints any of it.
    ("of the Gospel 4 is offered", "of the Gospel is offered"),
    ("“Ye shall return 4 ; { } hes ;</p><p>every man to his possession.", "“Ye shall return every man to his possession."),
    ("(Lev. 16: hale So Jesus bore my sins and , sicknesses", "(Lev. 16:22). So Jesus bore my sins and sicknesses"),
    ("to the cross. He +t Sin and sickness", "to the cross. Sin and sickness"),
    ("assume as a heavy ps ea burden", "assume as a heavy burden"),
    ("through the iy, ‘ Father’s loving", "through the Father’s loving"),
    ("confidence toward God. Y The command", "confidence toward God. The command"),
    ("and keeping it! i We must", "and keeping it! We must"),
    ("He that ‘ hath seen Me", "He that hath seen Me"),
    ("We have ’ seen in the preceding", "We have seen in the preceding"),
    ("a special ’ revelation", "a special revelation"),
    ("Los ‘Angeles", "Los Angeles"),
    ("and we‘have the plain", "and we have the plain"),
    ("say one word ‘in favor", "say one word in favor"),
    ("the salvation ‘of others", "the salvation of others"),
    ("testified in‘this Tabernacle", "testified in this Tabernacle"),
    ("too intense to to describe. ‘The doctors", "too intense to to describe. The doctors"),
    ("privilege and the ‘duty to ‘pray", "privilege and the duty to ‘pray"),
    ("“I need ‘the money,", "“I need the money,"),
    ("preservation, healing, health, © soundness", "preservation, healing, health, soundness"),
    ("I was taken © very ill", "I was taken very ill"),
    ("If every one © were to be", "If every one were to be"),
    ("the remembrance ~ of His holiness.”?", "the remembrance of His holiness.”"),
    ("in perils ~ among false brethren", "in perils among false brethren"),
    ("and when ~ my friend", "and when my friend"),
    ("remain, we _would urge", "remain, we would urge"),
    ("institution of the _ passover", "institution of the passover"),
    ("</p><p>_ Some, who have to admit", "</p><p>Some, who have to admit"),
    ("every moment, is _ still precisely", "every moment, is still precisely"),
    ("An _ unsound heart", "An unsound heart"),
    ("your reasonable _ service", "your reasonable service"),
    ("new dress, _ faith for", "new dress, faith for"),
    ("outside of Paul’s _ body", "outside of Paul’s body"),
    ("of which Paul _ here speaks", "of which Paul here speaks"),
    ("in the _sixth chapter", "in the sixth chapter"),
    ("abundantly than _all others", "abundantly than all others"),
    ("spiritually?</p><p>_ Would not", "spiritually?</p><p>Would not"),
    ("habit of _ bringing", "habit of bringing"),
    ("Some preachers, like - this man", "Some preachers, like this man"),
    ("relation to us that - these names", "relation to us that these names"),
    ("“the Lamb - of God", "“the Lamb of God"),
    ("and who was - Chairman", "and who was Chairman"),
    ("did not leave the - people", "did not leave the people"),
    ("for her suffering - child", "for her suffering child"),
    ("Paul saw that - the grace", "Paul saw that the grace"),
    ("from opthalmia - of the eyes", "from opthalmia of the eyes"),
    ("No mercy was offered -until", "No mercy was offered until"),
    ("God hath set -some in", "God hath set some in"),
    ("suppose that -He has abandoned", "suppose that He has abandoned"),
    ("because His -compassion", "because His compassion"),
    ("in this day. !</p>", "in this day.</p>"),
    ("the Antitype—. the Atonement", "the Antitype—the Atonement"),
    ("the greatest of the prophets,. in which", "the greatest of the prophets, in which"),
    ("fellowship of our. sufferings", "fellowship of our sufferings"),
    ("statement of our. complete redemption", "statement of our complete redemption"),
    ("faith for the thousand. dollars", "faith for the thousand dollars"),
    ("kings desired to. see,", "kings desired to see,"),
    ("after His return. to Heaven", "after His return to Heaven"),
    ("while He is with the Father. . Accordingly", "while He is with the Father. Accordingly"),
    ("our complete redemption. . JEHOVAH-NISSI", "our complete redemption. JEHOVAH-NISSI"),
    ("refers only to . His earthly", "refers only to His earthly"),
    ("(James 5:14.) . Does He mean", "(James 5:14.) Does He mean"),
    ("what we hope . for,", "what we hope for,"),
    ("law’s curse. In.other words", "law’s curse. In other words"),
    ("Of course, we.recognize,", "Of course, we recognize,"),
    ("Her son Was also.brought", "Her son was also brought"),
    ("until two.or three", "until two or three"),
    ("High Priest” for us. .</p>", "High Priest” for us.</p>"),
    ("“weak and sickly . ..”", "“weak and sickly . . .”"),
    ("“He .. . healed all", "“He . . . healed all"),
    ("children of Abraham . .. now to Abraham", "children of Abraham . . . now to Abraham"),
    ("as for the soul .. . Just as", "as for the soul . . . Just as"),
    ("life that now is . - - Individual", "life that now is . . . Individual"),
    ("needs of the race . .. Healing", "needs of the race . . . Healing"),
    ("preaching the Gospel .. . and healing every", "preaching the Gospel . . . and healing every"),
    ("saying . . « Go, preach", "saying . . . Go, preach"),
    ("one to another . .. that ye may be healed.” It is", "one to another . . . that ye may be healed.” It is"),
    ("with all thy heart .. .”", "with all thy heart . . .”"),
    ("will not be as God desires. » I Thes.", "will not be as God desires. I Thes."),
    ("nakedness.” ‘“Reviled - » . persecuted", "nakedness.” “Reviled . . . persecuted"),
    ("oriental diseases . .. a pitiable", "oriental diseases . . . a pitiable"),
    ("premature death. . . - Of course", "premature death. . . . Of course"),
    ("the “thorn in the flesh;’”? making", "the “thorn in the flesh;” making"),
    ("our sicknesses.”? This includes", "our sicknesses.” This includes"),
    ("The only “surely”? in the", "The only “surely” in the"),
    ("asked for ‘mercy’? when", "asked for “mercy” when"),
    ("The word “our”? means", "The word “our” means"),
    ("for the “inner”? man)", "for the “inner” man)"),
    ("but “at the first”? does", "but “at the first” does"),
    ("the works of the devil’? in the members", "the works of the devil” in the members"),
    ("To “every creature ”’ Throughout", "To “every creature ” Throughout"),
    ("except that his eyes, as” he stood", "except that his eyes, as he stood"),
    ("surely He redeemed us from sickness.’</p>", "surely He redeemed us from sickness.</p>"),
    ("God’s mercy covers man’s ' physical", "God’s mercy covers man’s physical"),
    # A paragraph broken at a page foot where the next page runs on
    # unindented (the scan's djvu.xml line coordinates), or at an initial.
    ("the cleansing of the leper.</p><p>Why an atonement", "the cleansing of the leper. Why an atonement"),
    ("must be read literally in Isaiah.</p><p>The same Holy Spirit", "must be read literally in Isaiah. The same Holy Spirit"),
    ("preparing for work for the Master.</p><p>Her husband wanted", "preparing for work for the Master. Her husband wanted"),
    ("to defeat His purpose.</p><p>I truly thank God", "to defeat His purpose. I truly thank God"),
    ("they “glorified the God of Israel.”</p><p>The higher critic", "they “glorified the God of Israel.” The higher critic"),
    ("as we would put away sin.</p><p>The consecrated christian", "as we would put away sin. The consecrated christian"),
    ("He was the sickest of men.</p><p>He had one of the worst", "He was the sickest of men. He had one of the worst"),
    ("“Glory” in the pocketbooks.</p><p>(No one knew", "“Glory” in the pocketbooks. (No one knew"),
    ("and the foot healed.</p><p>There has been no pain", "and the foot healed. There has been no pain"),
    ("call” upon Him?</p><p>Does not this glorious Gospel dispensation", "call” upon Him? Does not this glorious Gospel dispensation"),
    ("say “at the first?”</p><p>Probably, as some scholars", "say “at the first?” Probably, as some scholars"),
    ("and “sorrows.”</p><p>All who have taken", "and “sorrows.” All who have taken"),
    ("what his “thorn”</p><p>‘was. He says", "what his “thorn” was. He says"),
    ("her affliction, Mrs. J. B.</p><p>Long, of 38", "her affliction, Mrs. J. B. Long, of 38"),
    # Quotation marks. The face's double quotes OCR as runs of singles
    # (‘“‘, ’”’, ‘‘, ’’) or as a lone single; each is set to the mark both
    # witnesses print, or where they disagree to the one that closes (or
    # opens) the quotation it belongs to. Nested single quotes are kept.
    ("“firstfruits’ of our spir", "“firstfruits” of our spir"),
    ("ate the body’ (Weymouth’s", "ate the body” (Weymouth’s"),
    ("ry creature;’”’ showing us ", "ry creature;” showing us "),
    (" possession.””</p><p>God’s", " possession.”</p><p>God’s"),
    ("ion of sins.’”’ Adopt a blo", "ion of sins.” Adopt a blo"),
    (" of healing,’ etc. None i", " of healing,” etc. None i"),
    (" of healing.”’ To say that", " of healing.” To say that"),
    ("earnest” or “‘firstfruits’” of our spir", "earnest” or “firstfruits” of our spir"),
    (" this line. ‘Faith cometh", " this line. “Faith cometh"),
    ("is benefits,’ and then he", "is benefits,” and then he"),
    (" specifies, ‘Who forgivet", " specifies, “Who forgivet"),
    ("for Israel. ‘Know ye, the", "for Israel. “Know ye, the"),
    ("e promise.” ‘Therefore ye", "e promise.” “Therefore ye"),
    ("ick,” says, ‘“‘The Church t", "ick,” says, “The Church t"),
    (" translated ‘the Lord our", " translated “the Lord our"),
    ("f receiving ‘“‘the gift of ", "f receiving “the gift of "),
    ("ated “griefs’” and “sorrow", "ated “griefs” and “sorrow"),
    ("ities,” and ‘He shall bea", "ities,” and “He shall bea"),
    ("nt, because ‘without the ", "nt, because “without the "),
    ("t of us all.”’ Since sickn", "t of us all.” Since sickn"),
    (" have said, ‘Jehovah hath", " have said, “Jehovah hath"),
    ("ot provide? ‘He healed th", "ot provide? “He healed th"),
    ("l remarked, ““Man’s future", "l remarked, “Man’s future"),
    ("ather said: ‘What is the ", "ather said: “What is the "),
    (" statement: ‘The healing ", " statement: “The healing "),
    ("me power as “The Head,’ t", "me power as ‘The Head,’ t"),
    ("s, affirms: ‘“He who waive", "s, affirms: “He who waive"),
    ("arnate life.’ The late ab", "arnate life.” The late ab"),
    ("r has said: ‘On the cross", "r has said: “On the cross"),
    ("st’s “I will’ cancelled h", "st’s “I will” cancelled h"),
    ("mption, and “‘was written ", "mption, and “was written "),
    ("heir tribes.”’ It is here ", "heir tribes.” It is here "),
    ("r every man,’ and therefo", "r every man,” and therefo"),
    ("rgiveth all,’ for the ide", "rgiveth all,” for the ide"),
    ("e question, ‘Why would Go", "e question, “Why would Go"),
    ("ill for man.”’ Because the", "ill for man.” Because the"),
    ("urther say, ““No longer ca", "urther say, “No longer ca"),
    ("s the sick. ‘“‘He sendeth H", "s the sick. “He sendeth H"),
    ("not be sure.”’ But, should", "not be sure.” But, should"),
    ("or healing. ‘Now, when th", "or healing. “Now, when th"),
    ("yer of faith’ unless it i", "yer of faith” unless it i"),
    ("ance of the “‘same works” ", "ance of the “same works” "),
    (" translated ‘“‘mercy” is al", " translated “mercy” is al"),
    (" translated ‘“‘compassion,”", " translated “compassion,”"),
    (" that He is “‘plenteous in", " that He is “plenteous in"),
    (". Thank God ‘‘His mercy (c", ". Thank God “His mercy (c"),
    ("f the Spirit’’ include the", "f the Spirit” include the"),
    (" Jesus” may ‘‘be made mani", " Jesus” may “be made mani"),
    ("mortal flesh’—immortal li", "mortal flesh”—immortal li"),
    ("that we may ‘“‘receive a fu", "that we may “receive a fu"),
    ("nd averted. ‘If we would ", "nd averted. “If we would "),
    (" promise is “‘we shall not", " promise is “we shall not"),
    (" the answer—‘For this pur", " the answer—“For this pur"),
    ("f the devil.”” This purpos", "f the devil.” This purpos"),
    ("ed “any sick’ in it to be", "ed “any sick” in it to be"),
    ("/p><p>Since ‘‘the Body is ", "/p><p>Since “the Body is "),
    ("he Lord,” a ‘‘living sacri", "he Lord,” a “living sacri"),
    ("ill that we ‘“‘may abound u", "ill that we “may abound u"),
    ("ood works,” ‘‘zealous of g", "ood works,” “zealous of g"),
    (" of healing;”’ and it is “", " of healing;” and it is “"),
    (" is defined “‘merciful—com", " is defined “merciful—com"),
    (" is willing.’’ This is exa", " is willing.” This is exa"),
    (" “He is able’ to saying “", " “He is able” to saying “"),
    (" toward us. ‘He delightet", " toward us. “He delightet"),
    ("g to Peter, ‘We are all h", "g to Peter, “We are all h"),
    ("thee of God,’”’ and he foun", "thee of God,” and he foun"),
    ("t be uttered’’), I stand i", "t be uttered”), I stand i"),
    (" “compassion’’) means to s", " “compassion”) means to s"),
    ("s afflicted.”” Is it not s", "s afflicted.” Is it not s"),
    ("hat fear Him’. “Like as a", "hat fear Him”. “Like as a"),
    ("hat fear Him’. As the Hea", "hat fear Him”. As the Hea"),
    (" of healing;’’ and it was ", " of healing;” and it was "),
    ("n with Him. ‘“Howbeit Jesu", "n with Him. “Howbeit Jesu"),
    ("d of Israel.’’ Oh, how muc", "d of Israel.” Oh, how muc"),
    (" as preach. ‘His harvest’ is not only", " as preach. “His harvest” is not only"),
    ("nd villages.’’ His compass", "nd villages.” His compass"),
    ("“this Gospel’ (that He pr", "“this Gospel” (that He pr"),
    ("cies of God,’ which is th", "cies of God,” which is th"),
    ("Jesus said, ‘“‘When He, the", "Jesus said, “When He, the"),
    ("es, saying, ‘‘He that hath", "es, saying, “He that hath"),
    ("sion for us.’ Again, His ", "sion for us.” Again, His "),
    (" like flint;’”’ for, after ", " like flint;” for, after "),
    ("“Shepherd,” ‘Righteousnes", "“Shepherd,” “Righteousnes"),
    ("ighteousness’ and “Physic", "ighteousness” and “Physic"),
    ("eth forever;’’ and is “fro", "eth forever;” and is “fro"),
    ("he Gospels, ‘‘He healed th", "he Gospels, “He healed th"),
    ("g Atonement ‘Himself took", "g Atonement “Himself took"),
    ("their flesh.”” (See I Thes", "their flesh.” (See I Thes"),
    (" by hearing.”’ Now, the li", " by hearing.” Now, the li"),
    (" blessings, ‘“He that come", " blessings, “He that come"),
    ("a to “I Was,’ because the", "a to “I Was,” because the"),
    ("t to obtain “‘the gift of ", "t to obtain “the gift of "),
    ("eir tribes ;’”’ and wheneve", "eir tribes ;” and wheneve"),
    (" to be sent ‘‘to every cre", " to be sent “to every cre"),
    ("ery creature’’ with the pr", "ery creature” with the pr"),
    ("added Word, “‘everyone tha", "added Word, “everyone tha"),
    ("Jesus says, ‘“Repent and b", "Jesus says, “Repent and b"),
    (" the Gospel.’”’ Only those ", " the Gospel.” Only those "),
    ("t the devil,’’ because no ", "t the devil,” because no "),
    ("in His sight’’—that it is ", "in His sight”—that it is "),
    ("it is said, ‘““The Lord wil", "it is said, “The Lord wil"),
    (" 91:14). He “‘keepeth cove", " 91:14). He “keepeth cove"),
    ("aise him up,’ you, like N", "aise him up,” you, like N"),
    (" well said, ‘We hope for ", " well said, “We hope for "),
    ("gs not seen.”’ All that a ", "gs not seen.” All that a "),
    ("o the soul. ‘Thus saith t", "o the soul. “Thus saith t"),
    ("ly replies, ‘Why! Mamma p", "ly replies, “Why! Mamma p"),
    ("promised it!’ Now, you ha", "promised it!” Now, you ha"),
    ("ng vanities.”” In other wo", "ng vanities.” In other wo"),
    ("e fact that ‘‘God is plent", "e fact that “God is plent"),
    (" we must be “‘workers toge", " we must be “workers toge"),
    ("oes not say “‘instantly.”<", "oes not say “instantly.”<"),
    ("hat believe.’ When His Wo", "hat believe.” When His Wo"),
    ("steadfastly “‘believe that", "steadfastly “believe that"),
    ("t ye receive’ (Mark 11:24", "t ye receive” (Mark 11:24"),
    (" faith, and “‘faith withou", " faith, and “faith withou"),
    ("rks is dead,’ it is when ", "rks is dead,” it is when "),
    (", could not “‘went,” but h", ", could not “went,” but h"),
    ("ce of praise’—is to be of", "ce of praise”—is to be of"),
    (" His name.” ‘“Whoso offere", " His name.” “Whoso offere"),
    ("ifieth Me.” ‘Because Thy ", "ifieth Me.” “Because Thy "),
    ("praise thee.’ Praise Him ", "praise thee.” Praise Him "),
    ("Him because ‘‘God inhabits", "Him because “God inhabits"),
    ("ice on high,’”’ when the on", "ice on high,” when the on"),
    ("ophecy; for “‘holy men of ", "ophecy; for “holy men of "),
    ("ainly says, “They shall l", "ainly says, ‘They shall l"),
    ("s written,” “‘they shall r", "s written,” “they shall r"),
    ("l recover;” ‘‘The Lord sha", "l recover;” “The Lord sha"),
    (" devil says!’ “The devil ", " devil says!” “The devil "),
    (" devil says!’’ as though C", " devil says!” as though C"),
    (" his words, ‘Most gladly ", " his words, “Most gladly "),
    ("ly what the ‘‘thorn in the", "ly what the “thorn in the"),
    ("us that the ‘‘pricks”’ in the eyes", "us that the “pricks” in the eyes"),
    ("that Paul’s “‘thorn” must ", "that Paul’s “thorn” must "),
    (" in Canaan, ‘they shall b", " in Canaan, “they shall b"),
    ("n your eyes.”’ So, we see ", "n your eyes.” So, we see "),
    ("id we read, “‘the sons of ", "id we read, “the sons of "),
    (" translated ‘‘angel’”’ 181 times, ", " translated “angel” 181 times, "),
    ("angels” (or ‘““messengers,’) and an “an", "angels” (or “messengers,”) and an “an"),
    ("s when they “‘buffeted” Ch", "s when they “buffeted” Ch"),
    (" him reply, ‘““Him is lots ", " him reply, “Him is lots "),
    ("to Ananias, ‘‘I will show ", "to Ananias, “I will show "),
    (" distresses,’’ and all the", " distresses,” and all the"),
    ("in weakness.”’ When Paul s", "in weakness.” When Paul s"),
    ("ortal flesh,”’ but it is n", "ortal flesh,” but it is n"),
    (" deceivers, “‘as dying and", " deceivers, “as dying and"),
    ("d we live,” ‘‘as chastened", "d we live,” “as chastened"),
    (" not killed,’ “as sorrowf", " not killed,” “as sorrowf"),
    ("uring of all’ things unto", "uring of all things unto"),
    ("re eyes” or “‘sickness,” n", "re eyes” or “sickness,” n"),
    ("“the Gospel,’ and got a g", "“the Gospel,” and got a g"),
    ("not be cured’”’——I say is i", "not be cured’”——I say is i"),
    (" healing of ‘‘all the othe", " healing of “all the othe"),
    ("n the island’ of Melita, ", "n the island” of Melita, "),
    (" Bible says “‘faith cometh", " Bible says “faith cometh"),
    (" by hearing,’ but in thes", " by hearing,” but in thes"),
    ("ood works,” “‘zealous of g", "ood works,” “zealous of g"),
    ("y good work?’ Do these se", "y good work?” Do these se"),
    ("t the first.’ Probably th", "t the first.” Probably th"),
    ("f His bones;”’ that “‘we have the ", "f His bones;” that “we have the "),
    (" the body,”—‘‘The Lord for", " the body,”—“The Lord for"),
    ("hrist Jesus.”” Accordingly", "hrist Jesus.” Accordingly"),
    ("seed;” that ‘to Abraham a", "seed;” that “to Abraham a"),
    ("omises made;’’ and that “i", "omises made;” and that “i"),
    ("f them, but “‘all the othe", "f them, but “all the othe"),
    ("o recommend ‘“‘the fruit of", "o recommend “the fruit of"),
    ("hovah-Rapha,”’ God’s Coven", "hovah-Rapha,” God’s Coven"),
    ("nd “any sick’ in it to be", "nd “any sick” in it to be"),
    (" do His will’ or have us ", " do His will” or have us "),
    ("t a cancer,—‘“a plague,’ “a curse’—‘“the works of", "t a cancer,—“a plague,” “a curse”—“the works of"),
    ("eproaches,” ‘‘necessities,", "eproaches,” “necessities,"),
    ("secutions,” ‘“‘distresses” ", "secutions,” “distresses” "),
    ("tan’s angels’’ which he do", "tan’s angels” which he do"),
    (" disease of ‘“‘ophthalmia o", " disease of “ophthalmia o"),
    (" the Father?’—Kenneth Mac", " the Father?”—Kenneth Mac"),
    ("d’s purpose “‘to make the ", "d’s purpose “to make the "),
    (".” He said, ““How long has", ".” He said, “How long has"),
    (" so I said, ‘“‘Lord, I know", " so I said, “Lord, I know"),
    ("d and said, ‘‘Well, I am p", "d and said, “Well, I am p"),
    ("iend asked, “‘What are you", "iend asked, “What are you"),
    ("mpter said, ‘You cannot d", "mpter said, “You cannot d"),
    ("<p>‘Who but Satan’s angel", "<p>Who but Satan’s angel"),
])
# --- end christ-the-healer ---

# Ever-Increasing Faith (Wigglesworth, 1924) — OCR slips in the Library of
# Congress scan `everincreasingfa00wigg_0`, each read against the page image
# and the later Gospel Publishing House printing (`everincreasingfa0000smit`).
# The PRINTER's own slips are left as printed and are NOT here: "inpartation",
# "minstered", "hosiptals", "unmanagable", "gloryify", "chastized", "abun-ance",
# "deliv-ance", "tok our infirmities", "picked up by tools", "Scandanavia" …
# That roughness is the 1924 text. See `build_ever_increasing_faith`.
BODY_CORRECTIONS.setdefault("ever-increasing-faith", {}).setdefault("replacements", []).extend([
    # A LINE the scanner dropped at the foot of p. 22 — "it was Jesus!” He
    # said, “Was it He? Oh, Jesus! Je-" — so the next page's "sus!" dangled.
    ("I said, “No, sus ! Jesus, save me.”",
     "I said, “No, it was Jesus!” He said, “Was it He? Oh, Jesus! Jesus! Jesus, save me.”"),
    # Close-quote marks the scanner read as other marks: "/’", "/'", ",,",
    # "’’", "*", a lone "’" or "/".
    ("I know I’m healed.’’ She", "I know I’m healed.” She"),
    ("baptized in the Holy Ghost - ” “I am", "baptized in the Holy Ghost——” “I am"),
    ("the word of wisdom. ” I want", "the word of wisdom.” I want"),
    ("My leg is healed.,, Afterwards", "My leg is healed.” Afterwards"),
    ("Help me too/’ and", "Help me too,” and"),
    ("It has gone.* Then", "It has gone.” Then"),
    ("“Reader,’ testified", "“Reader,” testified"),
    ("your hands/’ We held", "your hands.” We held"),
    ("this man strong/' The anointing", "this man strong.” The anointing"),
    ("“Dadda, come/’ I cried", "“Dadda, come.” I cried"),
    ("forgive me/’ I made", "forgive me.” I made"),
    ("in this world/’ Not that", "in this world.” Not that"),
    ("“I cannot turn over.,, His", "“I cannot turn over.” His"),
    ("gates of death/ ”", "gates of death.’”"),
    ("way of escape.,,", "way of escape.”"),
    ("shrivelled up/ and", "shrivelled up,’ and"),
    ("be still !’ and", "be still!” and"),
    ("have you ignorant/' There", "have you ignorant.” There"),
    ("visions and revelations/’ God", "visions and revelations.” God"),
    ("with me today/’ The dog", "with me today.” The dog"),
    ("an evil spirit/’ I lifted", "an evil spirit.” I lifted"),
    ("stop at Gilgal Elisha said", "stop at Gilgal,” Elisha said"),
    ("to trust God/</p>", "to trust God.</p>"),
    ("in His name/ I walked", "in His name. I walked"),
    ("to her, ‘‘Let the children", "to her, “Let the children"),
    ("to his wife, ‘‘If you desire", "to his wife, “If you desire"),
    # An opening quote the scanner dropped at a paragraph's head (1 Cor. 14:21).
    ("<p>In the law it is written, With", "<p>“In the law it is written, With"),
    # Specks of margin dirt read as punctuation.
    ("<p>. These are days", "<p>These are days"),
    ("lunch basket. ’ There", "lunch basket. There"),
    ("the glory • He told", "the glory He told"),
    ("hate the thought, of going", "hate the thought of going"),
    ("should men seek; to be saved", "should men seek to be saved"),
    ("“Seek ye the Lord' while", "“Seek ye the Lord while"),
    ("had no money.! But", "had no money! But"),
    ("this man. had been", "this man had been"),
    ("an invalid;- but", "an invalid; but"),
    ("which be not as. though", "which be not as though"),
    ("came into the: church", "came into the church"),
    ("our God is. merciful", "our God is merciful"),
    ("our Pentecostal -church", "our Pentecostal church"),
    ("sitting together,. and", "sitting together, and"),
    ("ordinary man •chosen", "ordinary man chosen"),
    ("the Holy Ghost, was in him", "the Holy Ghost was in him"),
    ("filled with the. Holy Ghost", "filled with the Holy Ghost"),
    ("the fire fell. ..I said", "the fire fell. I said"),
    ("saints like. that.", "saints like that."),
    ("everybody in- the assembly", "everybody in the assembly"),
    ("to give- one word", "to give one word"),
    ("in a meeting- where", "in a meeting where"),
    ("being somebody • There", "being somebody! There"),
    ("and destroy, lives", "and destroy lives"),
    ("and there , they stood", "and there they stood"),
    ("to the v Vicarage", "to the Vicarage"),
    # Letters misread.
    ("those on whom Fie places", "those on whom He places"),
    ("pressed his linger", "pressed his finger"),
    ("for over &amp;A years", "for over 6½ years"),
    ("said to me, “1 want", "said to me, “I want"),
    ("I ha've asked", "I have asked"),
    ("his bed^nd began", "his bed and began"),
    ("nothing to da with", "nothing to do with"),
    ("this man s body", "this man’s body"),
    ("“Pm very sick", "“I’m very sick"),
    ("That’s what Fm here", "That’s what I’m here"),
    ("“0 my God, stop", "“O my God, stop"),
    ("constantly tellin g what", "constantly telling what"),
    ("the Lord coming1 down", "the Lord coming down"),
    ("glorious power of GoL One", "glorious power of God. One"),
    ("Oli, this wonderful", "Oh, this wonderful"),
    ("What a saltation this", "What a salvation this"),
    ("may be one1;", "may be one;"),
    ("our Lord.” Wei can", "our Lord.” We can"),
    ("I wanf to tell", "I want to tell"),
    ("preaching axd a man", "preaching and a man"),
    ("the HolyGhost show", "the Holy Ghost show"),
    ("doors o-f opportunity", "doors of opportunity"),
    ("“It’ll neve,r go;”", "“It’ll never go;”"),
    ("“Here s the woman", "“Here’s the woman"),
    ("if yoq, will but", "if you will but"),
    ("God's hands", "God’s hands"),
    ("the Lord that 1 would", "the Lord that I would"),
    ("cabin and sa:d,", "cabin and said,"),
    ("Right there lie opened", "Right there he opened"),
    ("compassion ior his", "compassion for his"),
    ("and Elis gifts", "and His gifts"),
    ("unction back. W^e are", "unction back. We are"),
    ("been in si great crisis", "been in a great crisis"),
    ("They ivere all", "They were all"),
    ("“D©n’t, Dad", "“Don’t, Dad"),
    ("will hever want", "will never want"),
    ("Spirit's power", "Spirit’s power"),
    ("who lakes of the deep", "who takes of the deep"),
    ("the more we kn.^w we", "the more we know we"),
    ("But when lie gets", "But when he gets"),
    ("Ibw do I know tlfis?", "How do I know this?"),
    ("The Holv Ghost", "The Holy Ghost"),
    ("unknown tonp-ue till", "unknown tongue till"),
    ("Inability-full of it", "Inability—full of it"),
    ("and the mom began", "and the room began"),
    ("When tthe tongues", "When the tongues"),
    ("“I vvant you to stop", "“I want you to stop"),
])
BODY_CORRECTIONS["ever-increasing-faith"]["paragraph_breaks"] = [
