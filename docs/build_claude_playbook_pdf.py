  ...
  <div>
    ...
    <table>
      ...
      <tr><td class="k">Ochorus<br><span style="font-weight:400;color:var(--muted)">frontend</span></td>
          <td><code>npm run check</code> &middot; <code>npm run build</code> &middot; <code>npm run sync:catalogues</code> after touching <code>messages/*.json</code></td></tr>
...
<div class="cols3">
  ...
  <div class="card acc"><h3>Keep the catalogues in sync</h3>
    ...
    <code>npm run sync:catalogues</code> automatically &mdash; the same shape as your Paraglide hook. A
