...
/**
 * Three modules are loaded straight from Node by build scripts
 * (`scripts/generate-sermon-og.mjs`, `scripts/generate-emblem-hues.mjs`,
 * `scripts/generate-cover-og.mjs`) under its TypeScript type stripping. Node does no extension resolution and knows
...
describe('modules the build scripts load under bare Node', () => {
	const FILES = ['src/lib/emblems.ts', 'src/lib/emblemNames.ts', 'src/lib/coverStyles.ts'];
