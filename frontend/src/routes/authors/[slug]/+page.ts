// prerender refresh 2026-09-24: Swahili author bio bill-bright (#2567). Author pages are
// prerendered PER AUTHOR, so /sw/authors/bill-bright must rebuild with the translated bio.
...
// prerender refresh 2026-09-24: Swahili author bio blasio-kigozi (#2569). Author pages are
// prerendered PER AUTHOR, so /sw/authors/blasio-kigozi must rebuild with the translated bio.
...
// julia-foote (#2241), richard-allen (#2242). Author pages are prerendered PER AUTHOR, so
// each /fr/authors/<slug> page must rebuild for the translated bio and its <blockquote>
...
// /fr/authors/<slug> page must rebuild for the translated bio and its <blockquote>
// pull-quotes and prayer callouts.
// prerender refresh 2026-09-10: French author bios (batch 2) — john-newton (#2029),
// john-chrysostom (#2033), alexander-maclaren (#2034). Author pages are prerendered PER
...
// bio_html and the new short bio.
//
...
//
// Prerender refresh 2026-07-31 (queue jobs #620/#621/#622/#623): four more
// Arabic bios — F. B. Meyer, John Bunyan, Jonathan Edwards and John Wesley —
// taking ar to ten. Meyer carries three prayer callouts rather than the usual
