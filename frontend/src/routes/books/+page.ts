// prerender refresh 2026-09-24 (queue job #3171): Swahili book — grace-for-grace-2, Watchman Nee's
// teaching on grace through the parables and Gospel scenes ("Neema Juu ya Neema"), 9 chapters. Book
...
// /books and the For Young Readers shelf so the card and its young-style plate cover (volume 2)
// appear, and the reader pages bake the chapters. Backs the new sons-of-the-king-book-2-30-days plan.
...
// 32 chapters; BSB Scripture). Rebuilds /books and the For Young Readers shelf so the card and its
// young-style plate cover appear, and the reader pages bake the chapters. Backs the new
// sons-of-the-king-book-1-30-days plan.
// prerender refresh 2026-09-23: one NEW English book — daughters-of-the-king-1, "Daughters of the
// King – 30 Days with God for Girls – Book 1" (Beloved), the first volume of a house-written devotional
// series for girls aged 9–12 and a new Series row (Ochorus Originals; Introduction, Day 1–30,
// Conclusion = 32 chapters; BSB Scripture). Rebuilds /books and the For Young Readers shelf so the
// card and its young-style plate cover appear, and the reader pages bake the chapters. Backs the new
// daughters-of-the-king-book-1-30-days plan.
...
// LAUNCH_PLANS/CURATED_PLANS entry, so no plans/+page.ts touch owed.
// prerender refresh 2026-09-18: one NEW Swahili book — on-loving-god (#2583), Bernard of
// Clairvaux's twelfth-century treatise on why and how we ought to love God, 11 chapters
// ("Kumpenda Mungu"). Rebuilds /sw/books so the card carries its translated title over the shared
// painting cover, and the reader page bakes the 11 chapters. Backs no LAUNCH_PLANS/CURATED_PLANS entry.
...
// completes the faith-in-the-fire plan in sw (he-holds-my-tomorrows.sw already shipped) — see the
// plans/+page.ts touch; days-of-heaven and watchman-nee back no plan.
// prerender refresh 2026-09-07: three NEW Swahili books — women-who-moved-heaven-2 (#1787),
// gleanings-among-the-sheaves (#1719), the-gospel-of-healing (#1721). 40 chapters. Rebuilds /sw/books.
